...
async function Registrar() {
  ...
  var placa_semirremolque = document.getElementById("placa_semirremolque").value;
  ...
  var tipo_unidadparticular = document.getElementById("tipo_unidadparticular").value;
  ...
  var personal_informante = document.getElementById("personal_informante").value;
  var gestor = document.getElementById("gestor").value;
  var fecha_recepcion_informacion = document.getElementById("fecha_recepcion_informacion").value;
  var hora_recepcion_informacion = document.getElementById("hora_recepcion_informacion").value;
  ...
  var supervisores_informados = document.getElementById("supervisores_informados").value;
  ...
  const respuesta = await fetch(
    'https://sheetdb.io/api/v1/sh9eom904m66a',
    {
      method: "POST",
      headers: {
...
function Previsualizar() {
  ...
  <table id="table2">
    ...
    <tr>
      <td colspan="7"><label for="">Fotos:</label></textarea></td>
    </tr>
    <tr>
      <th colspan="7">REPORTADO POR:</th>
    </tr>
    <tr>
      <th colspan="2">NOMBRE</th>
      <th colspan="1">CARGO</th>
      <th colspan="1">FECHA (año / mes / día)</th>
